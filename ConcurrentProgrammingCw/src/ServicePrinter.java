...
public interface ServicePrinter extends Printer
{
    ...
    public void replaceTonerCartridge(TonerTechnician tonerTechnician, int numOfReplaceAttempt ) ;

    public void refillPaper( PaperTechnician paperTechnician, int numOfRefillAttempt) ;
